    ...
    extend: {
      ...
      keyframes: {
        ...
        "float": {
          ...
          "50%": { transform: "rotateX(8deg) rotateY(-8deg) translateY(-12px)" },
        },
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px 0px rgba(255, 81, 47, 0.3)" },
          "50%": { boxShadow: "0 0 40px 10px rgba(221, 36, 118, 0.4)" },
        },
        "shimmer": {
      ...
      animation: {
        ...
        "slide-in-right-bottom": "slide-in-right-bottom 0.3s ease-out",
      },
    },
  },
