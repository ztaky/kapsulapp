...
export function Pricing({ content, landingSlug, installmentsEnabled, installmentsCount = 3, onCheckout, primaryColor = '#e11d48', primaryDarkColor = '#9333ea' }: PricingProps) {
