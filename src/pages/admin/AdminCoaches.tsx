...
const AdminCoaches = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-foreground mb-2">Coachs</h1>
        <p className="text-muted-foreground">Tous les formateurs de la plateforme</p>
      </div>
                    ...
                    <tr key={coach.id} className="border-b hover:bg-muted/50 transition-colors">
                      <td className="py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-semibold text-foreground">{coach.profile.full_name || "Sans nom"}</p>
                      ...
                      <td className="py-4">
                        <span className="text-foreground font-semibold">{coach.courses_count}</span>
                        <span className="text-muted-foreground ml-1">cours</span>
                      </td>
